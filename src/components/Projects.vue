<template>
    <div class="mt-16 text-left ">
        ...
        <div class="md:grid grid-cols-2 gap-6">
            <div class="mb-4 card p-8 leading-loose relative rounded-lg shadow w-auto" :class="(mode === 'dark') ? 'project-bg-dark' : 'bg-white'">
            ...
            <div class="mb-4 card p-8 leading-loose relative rounded-lg shadow" :class="(mode === 'dark') ? 'project-bg-dark' : 'bg-white'">
